...
function addtophead( $title )
{
	...
	<tr bgcolor=\"#000000\" valign=top>
		<td align=center>";
			...
			{
				echo "<img src=1p.gif alt=\"\" width=1 height=4>";
			}
		echo "
		</td>
		<td width=1 bgcolor=",makecol($menubordercol,$bgcol,64)," nowrap rowspan=4><img src=1p.gif alt=\"\" width=1 height=1></td>
		<td width=1 bgcolor=",makecol($menubordercol,$bgcol,128)," nowrap rowspan=5><img src=1p.gif alt=\"\" width=1 height=1></td>
		<td width=1 bgcolor=",makecol($menubordercol,$bgcol,196)," nowrap rowspan=4><img src=1p.gif alt=\"\" width=1 height=1></td>
	</tr>";
	echo "
		<tr><td bgcolor=",makecol($menubordercol,$menubgcol,255*1/3),"><img src=1p.gif alt=\"\" width=1 height=1></td></tr>
		<tr><td bgcolor=",makecol($menubordercol,$menubgcol,255*2/3),"><img src=1p.gif alt=\"\" width=1 height=1></td></tr>";
	echo "
...
function addtopend()
{
	...
	<tr><td bgcolor=",makecol($menubordercol,$bgcol,64)," colspan=2><img src=1p.gif alt=\"\" width=1 height=1></td></tr>
	<tr><td bgcolor=",makecol($menubordercol,$bgcol,128)," colspan=2><img src=1p.gif alt=\"\" width=1 height=1></td></tr>
	<tr><td bgcolor=",makecol($menubordercol,$bgcol,196),"><img src=1p.gif alt=\"\" width=1 height=1></td></tr> 
	<tr>
		<td>
			<font size=-2>&nbsp;</font>
		</td>
		...
		<td width=100 nowrap rowspan=99>
			<table width="100%" cellspacing=0 border=0 cellpadding=0>
				...
				<tr><td>
					...
					<br><br><br>
					Hosted by:<br>
					<a href="http://sourceforge.net"><img src="http://sourceforge.net/sflogo.php?group_id=724&amp;type=1" alt="sourceforge.net" width="88" height="31" border="0"></a>
					</center>
				</td></tr>
			</table>
